...
interface ThisContext {
  ...
  addItemToGui: ({targetGui = null, propertiesObject, propertiesToParse, additionalProps, jsonToParser}: {targetGui: GUI | null, propertiesObject: any, propertiesToParse: any, additionalProps: {[key: string]: any}, jsonToParser: any}) => void;
}
